...
using IslandCaller.TopmostEnhancerNet8.ViewModels;

namespace IslandCaller.TopmostEnhancerNet8.Views;

/// <summary>
/// 置顶增强设置页（纯代码构建，无 XAML 依赖）。
/// </summary>
[SettingsPageInfo("plugins.IslandCallerTopmostEnhancer", "IslandCaller 置顶增强（稳定版）", "\uE8B7", "\uE8B7", SettingsPageCategory.External)]
public partial class SettingsPage : SettingsPageBase
{
    ...
    private void BuildContent()
    {
        ...
        {
            Watermark = "逗号分隔，例如：FluentShower, LiquidShower"
        };
